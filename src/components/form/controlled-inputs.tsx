...
type PasswordControllerProps = ControlledFieldWrapperProps<InputProps>;

export const PasswordControlled: React.FC<PasswordControllerProps> = ({
  inputProps,
  ...props
}) => {
  return (
